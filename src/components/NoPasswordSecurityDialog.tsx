import {
  ...
  export function NoPasswordSecurityDialog({
    open,
    onOpenChange,
  }: {
    open: boolean;
    ...
    const { updateUserPasswordWithoutCurrent } = useApi();
    ...
    const { mutate: handleResetPassword, isPending: isChangingPassword } =
      useMutation({
        mutationFn: async (e: React.FormEvent) => {
          ...
          const res = await updateUserPasswordWithoutCurrent({new_password: newPassword});
