                    ...
                    <div className="flex justify-between items-start">
                      <div className="space-y-1">
                        <CardTitle className="flex items-center space-x-2">
                          ...
                          <Badge variant={getStatusColor(order.situacao)} className="flex items-center space-x-1">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex justify-between items-center">
                      <div className="space-y-1">
                        ...
                        <p className="text-sm text-muted-foreground">ID do pedido: {order.id}</p>
                      </div>
                      ...
                      <div className="w-full bg-muted rounded-full h-2">
                        <div 
                          className={`h-2 rounded-full transition-all duration-500 ${
                            order.situacao === 'Em aberto' ? 'w-1/4 bg-secondary' :
                            order.situacao === 'Processando' ? 'w-1/2 bg-accent' :
                            order.situacao === 'Enviado' ? 'w-3/4 bg-primary' :
